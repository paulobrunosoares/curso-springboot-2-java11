...
public class User implements Serializable {
	...
	/*
	 * public User(Long id, String name, String email, String phone, String
	 * password) { super(); this.id = id; this.name = name; this.email = email;
	 * this.phone = phone; this.password = password; } public Long getId() { return
	 ...
	 * this.email = email; } public String getPhone() { return phone; } public void
	 * setPhone(String phone) { this.phone = phone; } public String getPassword() {
	 ...
	 * false; User other = (User) obj; if (id == null) { if (other.id != null)
